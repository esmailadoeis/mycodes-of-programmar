...
<div class="path1">المجموعات<div class="path140">المجموعات /ادارة المجموعات </div></div>
<div onClick="window.open('g1','self')" class="path">  <button> اضافة مجموعة جديدة  </button>
</div>
...
<th  class="text" width="2%">التسلسل</th>
<th  class="text" width="10%">اسم المجموعة</th>
<th  class="text" width="10%">مستوى المجموعة</th>
<th  class="text" width="10%">حالة المجموعة</th>
<th  class="text" width="15%">التحكم</th>
</tr>
<?php
if(!isset($_GET['page'])){
		  $page=1;
...
$result333= mysql_query("SELECT * FROM g ");
...
$num = $myrow3330["str"];
		...
		$start =($page - 1 ) * $num;
		$end = $num ;
$result1 = mysql_query("SELECT * FROM g  limit $start , $end");
while($myrow1 = mysql_fetch_array ($result1)){

?> <tr>
<td> <span  class="bad"> <? echo $myrow1['id']; ?> </span></td>
<td>  <span  class="bad1">   <? echo $myrow1['name']; ?>  </span>   </td>
<td>    <span  class="bad12">  <? echo $myrow1['level']; ?>   </span>  </td>
<td>    <span  class="bad12">  <? echo $myrow1['status']; ?>   </span>  </td>
<td>   <span  class="bad12"> <a href="edit.php?id=<? echo $myrow1['id']; ?>"><div class="path123"><button>edit</button>
</div></a> </span>  
  <a href="delete.php?id=<? echo $myrow1['id']; ?>"><div class="path1234"><button>delete</button>
  </div></a> 
 </td>
</tr>
<?
...
<? 
		 ...
		 if($next<=$pagecount)
		 echo'<div class="path123456"><a href =group.php?id='.$id. '&page='.$next.'><h style="font-size:2vmin;">NEXT</h></a></div>';
			...
			if($prev >0)
			 ...
			 echo'<div class="path12345"><a href=group.php?id='.$id.'&page='.$prev.'><h style="font-size:2vmin;">PREVIUOS</a> </div>';
			 ?>
