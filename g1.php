...
<div class="path1">اضافة مجموعة<div class="e"><?  $q=$_GET['q'];if($q==2){
echo"تم اضافة المجموعة بنجاح";}
?>
 </div></div>
 <div class="form">
<form name="form1"   method="POST"  action="add_group1.php">
<p>اسم المجموعة</p>
 <input type="text" name="name" id="name" placeholder="ادخل اسم المجموعة">
<p>مستوى المحموعة</p>
 <input type="text" name="level" id="level"placeholder="ادخل مستوى المجموعة" >
 <p>حالة المجموعة</p>
 <select name="status">
 <option>  active</option>
 <option>  silence</option>
 </select>
  <p><button>  <input type="submit"  name="submit" class="path1236"value="نشر "></button> </p>
 </form></div>
<script>
