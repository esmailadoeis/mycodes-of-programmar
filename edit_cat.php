...
<div class="path1">تعديل تصنيف<div class="e"><?  $q=$_GET['q'];if($q==8){
echo"تم تعديل التصنيف بنجاح";}
...
$result111 = mysql_query("SELECT * FROM cats  WHERE  id='$id'");
$myrow111 = mysql_fetch_array ($result111);
?>
 <div class="form">
 <form action="update_cat.php" method="post">
<p>اسم التصنيف</p>
 <input type="text" name="name_cat" id="" value="<? echo $myrow111['name_cat']; ?>">

   <input name="id" type="hidden" id="id" value="<? echo $myrow111['id']; ?>">
