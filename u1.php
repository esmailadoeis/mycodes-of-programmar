...
<div class="path1">اضافة مستخدم<div class="e"><?  $q=$_GET['q'];if($q==3){
echo"تم اضافة المستخدم بنجاح";}
?> </div> </div>
 <div class="form">
 <form action="add_user.php" method="post">
<p>اسم المستخدم</p>
 <input type="text" name="name_user" id="name_user"placeholder="ادخل اسم المستخدم">
<p>كلمة السر</p>
 <input type="password" name="password" id="password" placeholder="ادخل كلمة السر">
 <p>حالة  المستخدم</p>
 <select name="status">
 <option>  مدير</option>
