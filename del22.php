...
<table width="900"  border="0" align="center"  bgcolor="#FFFFFF" class="main_berder">
  ...
  <tr>
   ...
   <?
   $id = $_GET['id'];
   $result333081= mysql_query("SELECT * FROM data WHERE  id='$id'");
		$myrow333081 = mysql_fetch_array ($result333081);
   ...
   ?>
	 ...
	 <input type="text" name="title" id="title"  value="<? echo $myrow333081['title'];?> " />
	 </label>
	 </p> 
	...
	<p><abel>ادخل وصفا جديد للموضوع<br />
	 ...
	 <p><abel>ادخل التاريخ<br />
	  ...
	  <textarea name="description" id="description" cols="40" rows="5"> <? echo $myrow333081['description'];?> </textarea>
	  </label>
	  </p>
	  <p><abel>ادخل نص الموضوع بالكامل<br />
	  <textarea name="text" id="text"  cols="40"rows="20">  <? echo $myrow333081['text'];?> </textarea>
	  </label>
	  
	  </p>
	  <p><abel>معد الموضوع<br />
	
	 <input type="text" name="author" id="author"  value="<? echo $myrow333081['author'];?> "/>
	 </label>
	 </p>
...
?>
	 ...
	 <input type="submit" name="submit" id="submit"  value="حذف الموضوع الجديد"/>
	 </label>
	 </p> 
	  </form>
