...
$search = $_POST['search'];}
    ...
    if(empty ($search))
{
echo  'عفوا انك لم تبحث عن اي كلمات';
exit(); 
}
  ...
  <tr>
   <td width="72%" align="right"  valign ="top" >
         ...
         <?php
           ...
           $result = mysql_query("SELECT id,title,description,date,author,mini_img,view,rating,q_vote FROM data where title like '%$search%' order by id asc   ");
