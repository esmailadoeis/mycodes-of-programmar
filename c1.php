...
<div class="path1">اضافة تصنيف<div class="e"><?  $q=$_GET['q'];if($q==1){
echo"تم اضافة التصنيف بنجاح";}
?> </div></div>
 <div class="form">
 <form action="addcat" method="post">
<p>اسم التصنيف</p>
 <input type="text" name="name_cat" id="" placeholder="ادخل التصنيف">

  
 <p><button>  <input type="submit"  name="submit" class="path1236"value="اضافة تصنيف "></button> </p>
